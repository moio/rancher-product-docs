...
# Replace <USERNAME> with your username and <TOKEN_OR_SECRET> with your access token or service account secret
...
# Install cert-manager from the SUSE Application Collection
